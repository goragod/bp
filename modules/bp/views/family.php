...
class View extends \Gcms\View
{
    ...
    public function onRow($item, $o, $prop)
    {
        ...
        $item['birthday'] = Date::compare($item['birthday'], date('Y-m-d'))['year'];
        $item['favorite'] = '<a id=favorite_'.$item['id'].' class="icon-valid '.($item['favorite'] ? 'success' : 'disabled').'" title="'.Language::find('FAVORITE_TITLE', '', $item['favorite']).'"></a>';
